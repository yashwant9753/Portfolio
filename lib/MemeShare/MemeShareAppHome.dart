...
class MemeShareDesktopScreen extends StatelessWidget {
  const MemeShareDesktopScreen({super.key});
...
class MemeShareTabletScreen extends StatelessWidget {
  const MemeShareTabletScreen({super.key});
...
class MemeShareMobileScreen extends StatelessWidget {
  const MemeShareMobileScreen({super.key});
