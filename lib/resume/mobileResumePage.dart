        ...
        children: [
          ...
          Row(
            children: [
              InkWell(
                onTap: () {
                  html.window.open(
                      "https://github.com/yashwant9753/MemeShare", "_blank");
                },
          ...
          Row(
            children: [
              InkWell(
                onTap: () {
                  html.window.open(
                      "https://github.com/yashwant9753/activities", "_blank");
                },
                child: OnHoverButton(builder: ((isHover) {
                  final color = isHover ? Colors.blue : Colors.black;
                  return Text(
              ...
              InkWell(
                onTap: () {
                  html.window
                      .open("https://github.com/yashwant9753/Apps", "_blank");
                },
                child: OnHoverButton(builder: ((isHover) {
                  final color = isHover ? Colors.blue : Colors.black;
                  return Text(
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: () {
                  html.window.open("https://youtu.be/fCKZEOzD9b8", "_blank");
                },
                child: OnHoverButton(builder: ((isHover) {
                  final color = isHover ? Colors.blue : Colors.black;
                  return Text(
          ...
          Text(
            """DISCOVER • Basic of Programming in Python • Principle of OOP • Connecting to SQLite Database • Developing a GUI with PyQT • Application of Python in Various Disciplines Modules. """,
            style: TextStyle(
                fontFamily: "CrimsonPro",
                color: Colors.white,
                fontSize: subHeadingSize!),
          ...
          Text(
            """DISCOVER • How to use Figma for Essential UX Design UI Design • Work with a UX Personas • Build a UX Project from Beginning to end. """,
            style: TextStyle(
                fontFamily: "CrimsonPro",
                color: Colors.white,
                fontSize: subHeadingSize!),
